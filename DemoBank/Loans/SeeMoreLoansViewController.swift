//
//  SeeMoreLoansViewController.swift
//  DemoBank
//
...
class SeeMoreLoansViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
